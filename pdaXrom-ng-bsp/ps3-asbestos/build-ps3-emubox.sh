...
INITRAMFS_MODULES="ps3vram usb-storage ohci-hcd sg vfat isofs udf"
INITRAMFS_MODULES_SEQUENCE="ps3vram usb-storage ohci-hcd sg vfat isofs udf sr_mod sd_mod scsi_mod"
