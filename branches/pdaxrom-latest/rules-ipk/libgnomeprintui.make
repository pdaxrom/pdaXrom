...
LIBGNOMEPRINTUI_VERSION		= 2.12.1
LIBGNOMEPRINTUI			= libgnomeprintui-$(LIBGNOMEPRINTUI_VERSION)
LIBGNOMEPRINTUI_SUFFIX		= tar.bz2
LIBGNOMEPRINTUI_URL		= http://ftp.gnome.org/pub/GNOME/sources/libgnomeprintui/2.12/$(LIBGNOMEPRINTUI).$(LIBGNOMEPRINTUI_SUFFIX)
...
$(STATEDIR)/libgnomeprintui.targetinstall: $(libgnomeprintui_targetinstall_deps)
	...
	VERSION=$(LIBGNOMEPRINTUI_VERSION) 		\
	ARCH=$(SHORT_TARGET) 						\
	MKIPKG=$(TOPDIR)/scripts/bin/mkipkg 				\
	$(TOPDIR)/scripts/bin/make-locale-ipks.sh libgnomeprintui $(LIBGNOMEPRINTUI_IPKG_TMP)
	...
	echo "Source: $(LIBGNOMEPRINTUI_URL)"						>>$(LIBGNOMEPRINTUI_IPKG_TMP)/CONTROL/control
