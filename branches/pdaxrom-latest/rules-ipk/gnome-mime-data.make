...
$(STATEDIR)/gnome-mime-data.targetinstall: $(gnome-mime-data_targetinstall_deps)
	...
	VERSION=$(GNOME-MIME-DATA_VERSION) 				\
	ARCH=$(SHORT_TARGET) 						\
	MKIPKG=$(TOPDIR)/scripts/bin/mkipkg 				\
	$(TOPDIR)/scripts/bin/make-locale-ipks.sh gnome-mime-data $(GNOME-MIME-DATA_IPKG_TMP)
	...
	echo "Source: $(GNOME-MIME-DATA_URL)"						>>$(GNOME-MIME-DATA_IPKG_TMP)/CONTROL/control
