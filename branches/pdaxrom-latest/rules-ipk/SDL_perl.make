...
SDL_perl_prepare_deps += $(STATEDIR)/MesaLib.install
endif
...
ifneq ("", $(PTXCONF_XFREE430_CONFIG))
SDL_perl_targetinstall_deps += $(STATEDIR)/MesaLib.targetinstall
endif
...
$(STATEDIR)/SDL_perl.targetinstall: $(SDL_perl_targetinstall_deps)
	...
	echo "Source: $(SDL_PERL_URL)"						>>$(SDL_PERL_IPKG_TMP)/CONTROL/control
