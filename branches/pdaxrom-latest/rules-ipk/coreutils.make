...
ifdef PTXCONF_COREUTILS_CKSUM
	$(COREUTILS_PATH) $(MAKE) -C $(COREUTILS_DIR)/src cksum
endif
	touch $@
...
ifdef PTXCONF_COREUTILS_CKSUM
	install $(COREUTILS_DIR)/src/cksum $(COREUTILS_DIR)/ipk/bin/cksum
	$(CROSSSTRIP) -R .note -R .comment $(COREUTILS_DIR)/ipk/bin/cksum
endif
	mkdir -p $(COREUTILS_DIR)/ipk/CONTROL
	echo "Package: coreutils" 						 >$(COREUTILS_DIR)/ipk/CONTROL/control
	echo "Source: $(COREUTILS_URL)"						>>$(COREUTILS_DIR)/ipk/CONTROL/control
