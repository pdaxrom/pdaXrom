...
ifdef PTXCONF_MTD_ERASEALL
	install $(MTD_DIR)/util/flash_eraseall $(MTD_DIR)/ipk/sbin
	$(CROSSSTRIP) -R .note -R .comment $(MTD_DIR)/ipk/sbin/flash_eraseall
endif
...
ifdef PTXCONF_MTD_MKJFFS2
	...
	echo "Source: $(MTD_URL)"						>>$(MTD_DIR)/ipk/CONTROL/control
