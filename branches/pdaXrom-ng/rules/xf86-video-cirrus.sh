...
XF86_VIDEO_CIRRUS=xf86-video-cirrus-1.2.1.tar.bz2
XF86_VIDEO_CIRRUS_MIRROR=ftp://ftp.freedesktop.org/pub/xorg/individual/driver
XF86_VIDEO_CIRRUS_DIR=$BUILD_DIR/xf86-video-cirrus-1.2.1
XF86_VIDEO_CIRRUS_ENV=

build_xf86_video_cirrus() {
    test -e "$STATE_DIR/xf86_video_cirrus-1.2.1" && return
    ...
    popd
    touch "$STATE_DIR/xf86_video_cirrus-1.2.1"
}
