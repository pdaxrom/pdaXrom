...
ifdef PTXCONF_GTK_TARGET_X11
	...
	@$(call install_copy, gtk, 0, 0, 0644, \
		$(GTK_DIR)/contrib/gdk-pixbuf-xlib/.libs/libgdk_pixbuf_xlib-2.0.so.0.1200.0, \
		/usr/lib/libgdk_pixbuf_xlib-2.0.so.0.1200.0)
	@$(call install_link, gtk, libgdk_pixbuf_xlib-2.0.so.0.1200.0, /usr/lib/libgdk_pixbuf_xlib-2.0.so.0)
	@$(call install_link, gtk, libgdk_pixbuf_xlib-2.0.so.0.1200.0, /usr/lib/libgdk_pixbuf_xlib-2.0.so)
endif
