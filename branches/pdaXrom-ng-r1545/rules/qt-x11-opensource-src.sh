...
QT_X11_OPENSOURCE_SRC_VERSION=4.4.3
QT_X11_OPENSOURCE_SRC=qt-x11-opensource-src-${QT_X11_OPENSOURCE_SRC_VERSION}.tar.bz2
QT_X11_OPENSOURCE_SRC_MIRROR=ftp://ftp.trolltech.com/qt/source
QT_X11_OPENSOURCE_SRC_DIR=$BUILD_DIR/qt-x11-opensource-src-${QT_X11_OPENSOURCE_SRC_VERSION}
