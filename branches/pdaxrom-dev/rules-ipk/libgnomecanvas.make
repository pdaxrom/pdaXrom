...
LIBGNOMECANVAS_VERSION		= 2.14.0
LIBGNOMECANVAS			= libgnomecanvas-$(LIBGNOMECANVAS_VERSION)
LIBGNOMECANVAS_SUFFIX		= tar.bz2
LIBGNOMECANVAS_URL		= ftp://ftp.gnome.org/pub/GNOME/sources/libgnomecanvas/2.14/$(LIBGNOMECANVAS).$(LIBGNOMECANVAS_SUFFIX)
...
$(STATEDIR)/libgnomecanvas.targetinstall: $(libgnomecanvas_targetinstall_deps)
	...
	$(TOPDIR)/scripts/bin/make-locale-ipks.sh libgnomecanvas $(LIBGNOMECANVAS_IPKG_TMP)
	...
	echo "Source: $(LIBGNOMECANVAS_URL)"						>>$(LIBGNOMECANVAS_IPKG_TMP)/CONTROL/control
