...
LIBGNOMEUI_VERSION	= 2.15.91
LIBGNOMEUI		= libgnomeui-$(LIBGNOMEUI_VERSION)
LIBGNOMEUI_SUFFIX	= tar.bz2
LIBGNOMEUI_URL		= ftp://ftp.gnome.org/pub/GNOME/sources/libgnomeui/2.15/$(LIBGNOMEUI).$(LIBGNOMEUI_SUFFIX)
...
libgnomeui_prepare_deps += $(STATEDIR)/gnome-keyring.install
...
libgnomeui_targetinstall_deps += $(STATEDIR)/gnome-keyring.targetinstall
...
$(STATEDIR)/libgnomeui.targetinstall: $(libgnomeui_targetinstall_deps)
	...
	$(TOPDIR)/scripts/bin/make-locale-ipks.sh libgnomeui $(LIBGNOMEUI_IPKG_TMP)
	...
	echo "Source: $(LIBGNOMEUI_URL)"						>>$(LIBGNOMEUI_IPKG_TMP)/CONTROL/control
