...
MODULE-INIT-TOOLS_VERSION		= 3.3-pre11
MODULE-INIT-TOOLS			= module-init-tools-$(MODULE-INIT-TOOLS_VERSION)
MODULE-INIT-TOOLS_SUFFIX		= tar.bz2
MODULE-INIT-TOOLS_URL			= http://www.kernel.org/pub/linux/kernel/people/jcm/module-init-tools/$(MODULE-INIT-TOOLS).$(MODULE-INIT-TOOLS_SUFFIX)
...
$(STATEDIR)/module-init-tools.targetinstall: $(module-init-tools_targetinstall_deps)
	...
	echo "Source: $(MODULE-INIT-TOOLS_URL)"						>>$(MODULE-INIT-TOOLS_IPKG_TMP)/CONTROL/control
...
ifdef PTXCONF_MODUTILS
module-init-tools_imageinstall_deps += $(STATEDIR)/modutils.imageinstall
endif
