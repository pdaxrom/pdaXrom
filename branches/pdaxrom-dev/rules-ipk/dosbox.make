...
###DOSBOX_VERSION		= 0.61
###DOSBOX_VERSION		= 0.63
#DOSBOX_VERSION		= 14112005
DOSBOX_VERSION		= 0.65
DOSBOX			= dosbox-$(DOSBOX_VERSION)
DOSBOX_SUFFIX		= tar.gz
DOSBOX_URL		= http://ovh.dl.sourceforge.net/sourceforge/dosbox/$(DOSBOX).$(DOSBOX_SUFFIX)
...
$(STATEDIR)/dosbox.prepare: $(dosbox_prepare_deps)
	...
	cd $(DOSBOX_DIR) && $(DOSBOX_PATH) ./autogen.sh
	cd $(DOSBOX_DIR) && \
...
$(STATEDIR)/dosbox.targetinstall: $(dosbox_targetinstall_deps)
	...
	echo "Source: $(DOSBOX_URL)"							>>$(DOSBOX_IPKG_TMP)/CONTROL/control
