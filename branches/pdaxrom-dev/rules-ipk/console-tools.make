...
$(STATEDIR)/console-tools.targetinstall: $(console-tools_targetinstall_deps)
	...
	echo "Source: $(CONSOLE-TOOLS_URL)" 					>>$(CONSOLE-TOOLS_IPKG_TMP)/CONTROL/control
	...
	rm -rf $(CONSOLE-TOOLS_IPKG_TMP)
	mkdir -p $(CONSOLE-TOOLS_IPKG_TMP)/usr/bin
	cp -a  $(CONSOLE-TOOLS_IPKG_TMP)-all/usr/bin/consolechars $(CONSOLE-TOOLS_IPKG_TMP)/usr/bin/
	mkdir -p $(CONSOLE-TOOLS_IPKG_TMP)/CONTROL
	echo "Package: console-tools-consolechars"				 >$(CONSOLE-TOOLS_IPKG_TMP)/CONTROL/control
	echo "Source: $(CONSOLE-TOOLS_URL)" 					>>$(CONSOLE-TOOLS_IPKG_TMP)/CONTROL/control
	echo "Priority: optional" 						>>$(CONSOLE-TOOLS_IPKG_TMP)/CONTROL/control
	echo "Section: Console" 						>>$(CONSOLE-TOOLS_IPKG_TMP)/CONTROL/control
	echo "Maintainer: Alexander Chukov <sash@pdaXrom.org>" 			>>$(CONSOLE-TOOLS_IPKG_TMP)/CONTROL/control
	...
	rm -f $(CONSOLE-TOOLS_IPKG_TMP)/usr/bin/consolechars
	mkdir -p $(CONSOLE-TOOLS_IPKG_TMP)/CONTROL
...
ifdef PTXCONF_CONSOLE-TOOLS-CONSOLECHARS_INSTALL
	cd $(FEEDDIR) && $(XIPKG) install console-tools-consolechars
endif
ifndef PTXCONF_CONSOLE-TOOLS-LOADKEYS_INSTALL
ifndef PTXCONF_CONSOLE-TOOLS-CONSOLECHARS_INSTALL
