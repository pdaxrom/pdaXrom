...
# Paths and names
#
#THUNDERBIRD_VERSION		= 1.0.7
THUNDERBIRD_VERSION		= 1.5.0.5
THUNDERBIRD			= thunderbird-$(THUNDERBIRD_VERSION)-source
THUNDERBIRD_SUFFIX		= tar.bz2
THUNDERBIRD_URL			= ftp://ftp.mozilla.org/pub/mozilla.org/thunderbird/releases/$(THUNDERBIRD_VERSION)/source/$(THUNDERBIRD).$(THUNDERBIRD_SUFFIX)
...
###endif
	...
	echo "Source: $(THUNDERBIRD_URL)"						>>$(THUNDERBIRD_IPKG_TMP)/CONTROL/control
