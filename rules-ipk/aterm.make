...
#
#ATERM_VERSION		= 0.4.2
ATERM_VERSION		= 1.00.beta2
ATERM			= aterm-$(ATERM_VERSION)a
...
ATERM_DIR		= $(BUILDDIR)/aterm-$(ATERM_VERSION)
...
$(STATEDIR)/aterm.targetinstall: $(aterm_targetinstall_deps)
	...
	echo "Source: $(ATERM_URL)"			>>$(ATERM_IPKG_TMP)/CONTROL/control
