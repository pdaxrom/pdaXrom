...
$(STATEDIR)/shared-mime-info.targetinstall: $(shared-mime-info_targetinstall_deps)
	...
	VERSION=$(SHARED-MIME-INFO_VERSION) 		\
	ARCH=$(SHORT_TARGET) 						\
	MKIPKG=$(TOPDIR)/scripts/bin/mkipkg 				\
	$(TOPDIR)/scripts/bin/make-locale-ipks.sh shared-mime-info $(SHARED-MIME-INFO_IPKG_TMP)
	...
	echo "Source: $(SHARED-MIME-INFO_URL)"						>>$(SHARED-MIME-INFO_IPKG_TMP)/CONTROL/control
