...
X11ROM-SETTINGS_URL		= http://www.pdaxrom.org/src/$(X11ROM-SETTINGS).$(X11ROM-SETTINGS_SUFFIX)
...
#	$(DESK2ROX) $(X11ROM-SETTINGS_DIR)/xcardinfo/xcardinfo.desktop $(X11ROM-SETTINGS_IPKG_TMP)/usr/apps
	...
	echo "Source: $(X11ROM-SETTINGS_URL)"						>>$(X11ROM-SETTINGS_IPKG_TMP)/CONTROL/control
