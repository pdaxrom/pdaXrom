...
$(STATEDIR)/perl.extract: $(perl_extract_deps)
	...
	rm -f $(PERL_DIR)/Cross/config.sh-arm-linux
	@$(call patchin, $(PERL))
	touch $@
...
ifdef PTXCONF_OPT_I686
 ...
 ifdef PTXCONF_ARCH_PPC
	perl -i -p -e "s,\@IPKG_TMP\@,$(PERL_IPKG_TMP),g" $(PERL_DIR)/Cross/config.sh-powerpc-linux
 else
...
$(STATEDIR)/perl.targetinstall: $(perl_targetinstall_deps)
	...
	echo "Source: $(PERL_URL)"						>>$(PERL_IPKG_TMP)/CONTROL/control
