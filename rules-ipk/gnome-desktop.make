...
$(STATEDIR)/gnome-desktop.targetinstall: $(gnome-desktop_targetinstall_deps)
	...
	VERSION=$(GNOME-DESKTOP_VERSION)				 		\
	ARCH=$(SHORT_TARGET) 								\
	MKIPKG=$(TOPDIR)/scripts/bin/mkipkg 						\
	$(TOPDIR)/scripts/bin/make-locale-ipks.sh gnome-desktop $(GNOME-DESKTOP_IPKG_TMP)
	...
	echo "Source: $(GNOME-DESKTOP_URL)"						>>$(GNOME-DESKTOP_IPKG_TMP)/CONTROL/control
