...
$(STATEDIR)/gnome-icon-theme.targetinstall: $(gnome-icon-theme_targetinstall_deps)
	...
	VERSION=$(GNOME-ICON-THEME_VERSION) 				\
	ARCH=$(SHORT_TARGET) 						\
	MKIPKG=$(TOPDIR)/scripts/bin/mkipkg 				\
	$(TOPDIR)/scripts/bin/make-locale-ipks.sh gnome-icon-theme $(GNOME-ICON-THEME_IPKG_TMP)
	...
	echo "Source: $(GNOME-ICON-THEME_URL)"						>>$(GNOME-ICON-THEME_IPKG_TMP)/CONTROL/control
