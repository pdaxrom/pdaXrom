...
LIBRSVG_VERSION		= 2.12.7
LIBRSVG			= librsvg-$(LIBRSVG_VERSION)
LIBRSVG_SUFFIX		= tar.bz2
LIBRSVG_URL		= ftp://ftp.gnome.org/pub/GNOME/sources/librsvg/2.12/$(LIBRSVG).$(LIBRSVG_SUFFIX)
...
$(STATEDIR)/librsvg.targetinstall: $(librsvg_targetinstall_deps)
	...
	echo "Source: $(LIBRSVG_URL)"						>>$(LIBRSVG_IPKG_TMP)/CONTROL/control
