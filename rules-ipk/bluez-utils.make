...
$(STATEDIR)/bluez-utils.targetinstall: $(bluez-utils_targetinstall_deps)
	...
	echo "Source: $(BLUEZ-UTILS_URL)"		>>$(BLUEZ-UTILS_IPKG_TMP)/CONTROL/control
	...
	echo "test -e /etc/rc.d/init.d/pcmcia && /etc/rc.d/init.d/pcmcia restart" >>$(BLUEZ-UTILS_IPKG_TMP)/CONTROL/postinst
...
$(STATEDIR)/bluez-utils.imageinstall: $(bluez-utils_imageinstall_deps)
	...
	rm -f $(ROOTDIR)/usr/lib/ipkg/info/bluez-utils.postinst
	touch $@
