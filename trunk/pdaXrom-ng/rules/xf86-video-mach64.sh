...
XF86_VIDEO_MACH64_VERSION=6.8.2
XF86_VIDEO_MACH64=xf86-video-mach64-${XF86_VIDEO_MACH64_VERSION}.tar.bz2
XF86_VIDEO_MACH64_MIRROR=ftp://ftp.freedesktop.org/pub/xorg/individual/driver
XF86_VIDEO_MACH64_DIR=$BUILD_DIR/xf86-video-mach64-${XF86_VIDEO_MACH64_VERSION}
