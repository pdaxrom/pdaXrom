...
$(STATEDIR)/libpng125.install: $(STATEDIR)/libpng125.compile
	...
	install $(LIBPNG125_DIR)/libpng12.so.0.1.2.8 $(PTXCONF_PREFIX)/$(PTXCONF_GNU_TARGET)/lib
	ln -sf libpng12.so.0.1.2.8 $(PTXCONF_PREFIX)/$(PTXCONF_GNU_TARGET)/lib/libpng12.so.0
	ln -sf libpng12.so.0.1.2.8 $(PTXCONF_PREFIX)/$(PTXCONF_GNU_TARGET)/lib/libpng12.so
...
$(STATEDIR)/libpng125.targetinstall: $(libpng125_targetinstall_deps)
	...
	install $(LIBPNG125_DIR)/libpng12.so.0.1.2.8 $(LIBPNG125_IPKG_TMP)/usr/lib
	$(CROSSSTRIP) $(LIBPNG125_IPKG_TMP)/usr/lib/libpng12.so.0.1.2.8
	ln -sf libpng12.so.0.1.2.8 $(LIBPNG125_IPKG_TMP)/usr/lib/libpng12.so.0
	ln -sf libpng12.so.0.1.2.8 $(LIBPNG125_IPKG_TMP)/usr/lib/libpng12.so
	ln -sf libpng12.so.0.1.2.8 $(LIBPNG125_IPKG_TMP)/usr/lib/libpng.so.3
	ln -sf libpng12.so.0.1.2.8 $(LIBPNG125_IPKG_TMP)/usr/lib/libpng.so

	mkdir -p $(LIBPNG125_IPKG_TMP)/CONTROL
	echo "Package: libpng"	 				 >$(LIBPNG125_IPKG_TMP)/CONTROL/control
	echo "Source: $(LIBPNG125_URL)"						>>$(LIBPNG125_IPKG_TMP)/CONTROL/control
