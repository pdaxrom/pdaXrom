...
ifdef PTXCONF_UTLNX_HWCLOCK
	...
	chmod u+s $(UTIL-LINUX_DIR)/ipkg_tmp/sbin/hwclock
endif
ifdef PTXCONF_UTLNX_IPCS
...
ifdef PTXCONF_UTLNX_FDISK
	...
	echo "Source: $(UTIL-LINUX_URL)"					>>$(UTIL-LINUX_DIR)/ipkg_tmp/CONTROL/control
	...
	echo "#!/bin/sh"				 >$(UTIL-LINUX_DIR)/ipkg_tmp/CONTROL/postinst
ifdef PTXCONF_UTLNX_HWCLOCK
	echo "chmod u+s /sbin/hwclock"			>>$(UTIL-LINUX_DIR)/ipkg_tmp/CONTROL/postinst
endif
