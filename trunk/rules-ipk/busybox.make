...
$(STATEDIR)/busybox.targetinstall: $(busybox_targetinstall_deps)
	...
	chmod +s $(BUSYBOX_DIR)/ipk/bin/busybox
	mkdir -p $(BUSYBOX_DIR)/ipk/CONTROL
	echo "Package: busybox" 						 >$(BUSYBOX_DIR)/ipk/CONTROL/control
	echo "Source: $(BUSYBOX_URL)"						>>$(BUSYBOX_DIR)/ipk/CONTROL/control
	...
	echo "#!/bin/sh"				 >$(BUSYBOX_DIR)/ipk/CONTROL/postinst
	echo "chmod  +s /bin/busybox"			>>$(BUSYBOX_DIR)/ipk/CONTROL/postinst
