...
# Paths and names
#
GNOME-KEYRING_VERSION	= 0.4.2
GNOME-KEYRING		= gnome-keyring-$(GNOME-KEYRING_VERSION)
GNOME-KEYRING_SUFFIX	= tar.bz2
GNOME-KEYRING_URL	= http://ftp.gnome.org/pub/GNOME/sources/gnome-keyring/0.4/$(GNOME-KEYRING).$(GNOME-KEYRING_SUFFIX)
...
$(STATEDIR)/gnome-keyring.targetinstall: $(gnome-keyring_targetinstall_deps)
	...
	VERSION=$(GNOME-KEYRING_VERSION) 				\
	ARCH=$(SHORT_TARGET) 						\
	MKIPKG=$(TOPDIR)/scripts/bin/mkipkg 				\
	$(TOPDIR)/scripts/bin/make-locale-ipks.sh gnome-keyring $(GNOME-KEYRING_IPKG_TMP)
	...
	echo "Source: $(GNOME-KEYRING_URL)"						>>$(GNOME-KEYRING_IPKG_TMP)/CONTROL/control
