...
$(STATEDIR)/rxvt-unicode.prepare: $(rxvt-unicode_prepare_deps)
	...
	echo "#define WTMP_FILE \"/var/log/wtmp\"" >>$(RXVT-UNICODE_DIR)/config.h
	echo "#define UTMP_FILE \"/var/run/utmp\"" >>$(RXVT-UNICODE_DIR)/config.h
	touch $@
...
$(STATEDIR)/rxvt-unicode.targetinstall: $(rxvt-unicode_targetinstall_deps)
	@$(call targetinfo, $@)
	rm -rf $(RXVT-UNICODE_IPKG_TMP)-d $(RXVT-UNICODE_IPKG_TMP)
	...
	tic -o $(RXVT-UNICODE_IPKG_TMP)/usr/share/terminfo $(RXVT-UNICODE_DIR)/doc/etc/rxvt-unicode.termcap
	...
	mkdir -p $(RXVT-UNICODE_IPKG_TMP)-d/usr/bin
	mv $(RXVT-UNICODE_IPKG_TMP)/usr/bin/{rxvtc,rxvtd} $(RXVT-UNICODE_IPKG_TMP)-d/usr/bin/
	mkdir -p $(RXVT-UNICODE_IPKG_TMP)-d/CONTROL
	echo "Package: rxvt-unicode-daemon" 								 >$(RXVT-UNICODE_IPKG_TMP)-d/CONTROL/control
	echo "Source: $(RXVT-UNICODE_URL)"								>>$(RXVT-UNICODE_IPKG_TMP)-d/CONTROL/control
	echo "Priority: optional" 									>>$(RXVT-UNICODE_IPKG_TMP)-d/CONTROL/control
	echo "Section: X11" 										>>$(RXVT-UNICODE_IPKG_TMP)-d/CONTROL/control
	echo "Maintainer: Alexander Chukov <sash@pdaXrom.org>" 						>>$(RXVT-UNICODE_IPKG_TMP)-d/CONTROL/control
	echo "Architecture: $(SHORT_TARGET)" 								>>$(RXVT-UNICODE_IPKG_TMP)-d/CONTROL/control
	...
	echo "Source: $(RXVT-UNICODE_URL)"								>>$(RXVT-UNICODE_IPKG_TMP)/CONTROL/control
