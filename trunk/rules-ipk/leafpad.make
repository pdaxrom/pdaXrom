...
$(STATEDIR)/leafpad.targetinstall: $(leafpad_targetinstall_deps)
	...
	VERSION=$(LEAFPAD_VERSION)-$(LEAFPAD_VENDOR_VERSION) 		\
	ARCH=$(SHORT_TARGET) 						\
	MKIPKG=$(TOPDIR)/scripts/bin/mkipkg 				\
	$(TOPDIR)/scripts/bin/make-locale-ipks.sh leafpad $(LEAFPAD_IPKG_TMP)
	...
	echo "Source: $(LEAFPAD_URL)"											>>$(LEAFPAD_IPKG_TMP)/CONTROL/control
