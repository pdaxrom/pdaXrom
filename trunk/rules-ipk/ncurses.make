...
$(STATEDIR)/ncurses.targetinstall: $(STATEDIR)/ncurses.install
	...
	cp -d $(NCURSES_DIR)/lib/libncurses.so* $(NCURSES_DIR)/ipk/usr/lib/
	$(CROSS_STRIP) --strip-unneeded -R .comment -R .note $(NCURSES_DIR)/ipk/usr/lib/libncurses.so*
...
ifdef PTXCONF_NCURSES_TERMCAP
	...
	echo "Source: $(NCURSES_URL)"						>>$(NCURSES_DIR)/ipk/CONTROL/control
