...
# Paths and names
#
#GNUMERIC_VERSION	= 1.6.0
GNUMERIC_VERSION	= 1.6.3
GNUMERIC		= gnumeric-$(GNUMERIC_VERSION)
GNUMERIC_SUFFIX		= tar.bz2
GNUMERIC_URL		= http://ftp.acc.umu.se/pub/GNOME/sources/gnumeric/1.6/$(GNUMERIC).$(GNUMERIC_SUFFIX)
...
ifdef PTXCONF_GNUMERIC_GNOME
GNUMERIC_AUTOCONF += --with-gnome
else
GNUMERIC_AUTOCONF += --without-gnome
endif
...
gnumeric_targetinstall_deps = \
	...
	$(STATEDIR)/goffice.targetinstall \
...
$(STATEDIR)/gnumeric.targetinstall: $(gnumeric_targetinstall_deps)
	...
	VERSION=$(GNUMERIC_VERSION)			 		\
	ARCH=$(SHORT_TARGET) 						\
	MKIPKG=$(TOPDIR)/scripts/bin/mkipkg 				\
	$(TOPDIR)/scripts/bin/make-locale-ipks.sh gnumeric $(GNUMERIC_IPKG_TMP)
...
ifndef PTXCONF_GNUMERIC_BONOBO
	...
	echo "Source: $(GNUMERIC_URL)"						>>$(GNUMERIC_IPKG_TMP)/CONTROL/control
