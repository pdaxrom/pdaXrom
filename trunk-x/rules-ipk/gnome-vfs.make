...
$(STATEDIR)/gnome-vfs.compile: $(gnome-vfs_compile_deps)
	@$(call targetinfo, $@)
	$(GNOME-VFS_PATH) $(GNOME-VFS_ENV) $(MAKE) -C $(GNOME-VFS_DIR)
	touch $@
...
$(STATEDIR)/gnome-vfs.targetinstall: $(gnome-vfs_targetinstall_deps)
	...
	VERSION=$(GNOME-VFS_VERSION)			 		\
	ARCH=$(SHORT_TARGET) 						\
	MKIPKG=$(TOPDIR)/scripts/bin/mkipkg 				\
	$(TOPDIR)/scripts/bin/make-locale-ipks.sh gnome-vfs $(GNOME-VFS_IPKG_TMP)
	...
	echo "Source: $(GNOME-VFS_URL)"						>>$(GNOME-VFS_IPKG_TMP)/CONTROL/control
