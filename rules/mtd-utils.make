...
# Paths and names
#
MTD_UTILS_VERSION	:= 20080514
MTD_UTILS		:= mtd-utils-snapshot-$(MTD_UTILS_VERSION)
MTD_UTILS_SUFFIX	:= tar.bz2
MTD_UTILS_URL		:= http://mail.pdaxrom.org/src/$(MTD_UTILS).$(MTD_UTILS_SUFFIX)
...
ifdef PTXCONF_MTD_UTILS_FLASH_ERASE
	@$(call install_copy, mtd-utils, 0, 0, 0755, $(MTD_UTILS_DIR)/$(PTXCONF_GNU_TARGET)/flash_erase, /sbin/flash_erase)
endif
ifdef PTXCONF_MTD_UTILS_FLASH_ERASEALL
	@$(call install_copy, mtd-utils, 0, 0, 0755, $(MTD_UTILS_DIR)/$(PTXCONF_GNU_TARGET)/flash_eraseall, /sbin/flash_eraseall)
endif
ifdef PTXCONF_MTD_UTILS_FLASH_INFO
	@$(call install_copy, mtd-utils, 0, 0, 0755, $(MTD_UTILS_DIR)/$(PTXCONF_GNU_TARGET)/flash_info, /sbin/flash_info)
endif
ifdef PTXCONF_MTD_UTILS_FLASH_LOCK
	@$(call install_copy, mtd-utils, 0, 0, 0755, $(MTD_UTILS_DIR)/$(PTXCONF_GNU_TARGET)/flash_lock, /sbin/flash_lock)
endif
ifdef PTXCONF_MTD_UTILS_FLASH_UNLOCK
	@$(call install_copy, mtd-utils, 0, 0, 0755, $(MTD_UTILS_DIR)/$(PTXCONF_GNU_TARGET)/flash_unlock, /sbin/flash_unlock)
endif
ifdef PTXCONF_MTD_UTILS_FLASHCP
	@$(call install_copy, mtd-utils, 0, 0, 0755, $(MTD_UTILS_DIR)/$(PTXCONF_GNU_TARGET)/flashcp, /sbin/flashcp)
endif
ifdef PTXCONF_MTD_UTILS_FTL_CHECK
	@$(call install_copy, mtd-utils, 0, 0, 0755, $(MTD_UTILS_DIR)/$(PTXCONF_GNU_TARGET)/ftl_check, /sbin/ftl_check)
endif
ifdef PTXCONF_MTD_UTILS_FTL_FORMAT
	@$(call install_copy, mtd-utils, 0, 0, 0755, $(MTD_UTILS_DIR)/$(PTXCONF_GNU_TARGET)/ftl_format, /sbin/ftl_format)
endif
ifdef PTXCONF_MTD_UTILS_JFFS2_DUMP
	@$(call install_copy, mtd-utils, 0, 0, 0755, $(MTD_UTILS_DIR)/$(PTXCONF_GNU_TARGET)/jffs2dump, /sbin/jffs2dump)
endif
#ifdef PTXCONF_MTD_UTILS_JFFS2READER
#	@$(call install_copy, mtd-utils, 0, 0, 0755, $(MTD_UTILS_DIR)/$(PTXCONF_GNU_TARGET)/jffs2reader, /sbin/jffs2reader)
#endif
ifdef PTXCONF_MTD_UTILS_MTDDEBUG
	@$(call install_copy, mtd-utils, 0, 0, 0755, $(MTD_UTILS_DIR)/$(PTXCONF_GNU_TARGET)/mtd_debug, /sbin/mtd_debug)
endif
ifdef PTXCONF_MTD_UTILS_NANDDUMP
	@$(call install_copy, mtd-utils, 0, 0, 0755, $(MTD_UTILS_DIR)/$(PTXCONF_GNU_TARGET)/nanddump, /sbin/nanddump)
endif
ifdef PTXCONF_MTD_UTILS_NANDWRITE
	@$(call install_copy, mtd-utils, 0, 0, 0755, $(MTD_UTILS_DIR)/$(PTXCONF_GNU_TARGET)/nandwrite, /sbin/nandwrite)
endif
ifdef PTXCONF_MTD_UTILS_NFTL_FORMAT
	@$(call install_copy, mtd-utils, 0, 0, 0755, $(MTD_UTILS_DIR)/$(PTXCONF_GNU_TARGET)/nftl_format, /sbin/nftl_format)
endif
ifdef PTXCONF_MTD_UTILS_NFTLDUMP
	@$(call install_copy, mtd-utils, 0, 0, 0755, $(MTD_UTILS_DIR)/$(PTXCONF_GNU_TARGET)/nftldump, /sbin/nftldump)
endif
ifdef PTXCONF_MTD_UTILS_MKJFFS
	@$(call install_copy, mtd-utils, 0, 0, 0755, $(MTD_UTILS_DIR)/$(PTXCONF_GNU_TARGET)/mkfs.jffs, /sbin/mkfs.jffs)
endif
ifdef PTXCONF_MTD_UTILS_MKJFFS2
	@$(call install_copy, mtd-utils, 0, 0, 0755, $(MTD_UTILS_DIR)/$(PTXCONF_GNU_TARGET)/mkfs.jffs2, /sbin/mkfs.jffs2)
endif
