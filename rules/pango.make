# -*-makefile-*-
# $Id: pango.make 7343 2007-10-03 01:19:14Z rsc $
#
...
ifdef PTXCONF_PANGO_TARGET_X11
	@$(call install_copy, pango, 0, 0, 0644, \
		$(PANGO_DIR)/pango/.libs/libpangoxft-1.0.so.0.1705.0, \
		/usr/lib/libpangoxft-1.0.so.0.1705.0)
	@$(call install_link, pango, libpangoxft-1.0.so.0.1705.0, /usr/lib/libpangoxft-1.0.so.0)
	@$(call install_link, pango, libpangoxft-1.0.so.0.1705.0, /usr/lib/libpangoxft-1.0.so)
endif
