...
SDLMAME_VERSION=0.139
SDLMAME=mame_${SDLMAME_VERSION}.orig.tar.bz2
SDLMAME_MIRROR=http://sdlmame4ubuntu.org/cur/major/pool/unofficial/m/mame
SDLMAME_DIR=$BUILD_DIR/mame-${SDLMAME_VERSION}
...
build_sdlmame() {
    ...
    C_ARGS="$C_ARGS $SDLMAME_MAKE_ARGS SUFFIX64="
    ...
    $INSTALL -D -m 644 $GENERICFS_DIR/sdlmame/ui.bdf $ROOTFS_DIR/usr/share/sdlmame/ui.bdf || error
    cp -a $GENERICFS_DIR/sdlmame/keymaps/*.txt $ROOTFS_DIR/usr/share/sdlmame/keymaps || error
