...
build_gtk2() {
    ...
    $INSTALL -D -m 644 gdk/.libs/libgdk-directfb-2.0.so.0.1600.0 $ROOTFS_DIR/usr/lib/libgdk-directfb-2.0.so.0.1600.0 || error
    ln -sf libgdk-directfb-2.0.so.0.1600.0 $ROOTFS_DIR/usr/lib/libgdk-directfb-2.0.so.0
    ln -sf libgdk-directfb-2.0.so.0.1600.0 $ROOTFS_DIR/usr/lib/libgdk-directfb-2.0.so
    $STRIP $ROOTFS_DIR/usr/lib/libgdk-directfb-2.0.so.0.1600.0
    
    $INSTALL -D -m 644 gtk/.libs/libgtk-directfb-2.0.so.0.1600.0 $ROOTFS_DIR/usr/lib/libgtk-directfb-2.0.so.0.1600.0 || error
    ln -sf libgtk-directfb-2.0.so.0.1600.0 $ROOTFS_DIR/usr/lib/libgtk-directfb-2.0.so.0
    ln -sf libgtk-directfb-2.0.so.0.1600.0 $ROOTFS_DIR/usr/lib/libgtk-directfb-2.0.so
    $STRIP $ROOTFS_DIR/usr/lib/libgtk-directfb-2.0.so.0.1600.0
