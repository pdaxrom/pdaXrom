...
#
	...
	echo "#!/bin/sh"						 >$(ROOTFS_DIR)/ipkg/CONTROL/postinst
	echo "chgrp -R mmedia /dev/{dsp*,audio*,mixer*,midi*,bvdd*}" 	>>$(ROOTFS_DIR)/ipkg/CONTROL/postinst
	chmod 755 $(ROOTFS_DIR)/ipkg/CONTROL/postinst
