...
$(STATEDIR)/mixmos.targetinstall: $(mixmos_targetinstall_deps)
	...
	VERSION=$(MIXMOS_VERSION)-$(MIXMOS_VENDOR_VERSION) 		\
	ARCH=$(SHORT_TARGET) 						\
	MKIPKG=$(TOPDIR)/scripts/bin/mkipkg 				\
	$(TOPDIR)/scripts/bin/make-locale-ipks.sh mixmos $(MIXMOS_IPKG_TMP)
	...
	echo "Source: $(MIXMOS_URL)"						>>$(MIXMOS_IPKG_TMP)/CONTROL/control
