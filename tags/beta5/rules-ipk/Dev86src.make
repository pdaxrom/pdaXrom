...
# Paths and names
#
DEV86SRC_VERSION	= 0.16.17
DEV86SRC		= Dev86src-$(DEV86SRC_VERSION)
DEV86SRC_SUFFIX		= tar.gz
DEV86SRC_URL		= http://homepage.ntlworld.com/robert.debath/dev86/$(DEV86SRC).$(DEV86SRC_SUFFIX)
...
$(STATEDIR)/Dev86src.targetinstall: $(Dev86src_targetinstall_deps)
	...
	echo "Source: $(DEV86SRC_URL)"			>>$(DEV86SRC_IPKG_TMP)/CONTROL/control
