...
$(STATEDIR)/dbus.targetinstall: $(dbus_targetinstall_deps)
	...
	rm -rf $(DBUS_IPKG_TMP)/usr/lib/python2.4/site-packages/*.*a
	rm -rf $(DBUS_IPKG_TMP)/usr/lib/python2.4/site-packages/*.py
	rm -rf $(DBUS_IPKG_TMP)/usr/lib/python2.4/site-packages/*.pyo
	...
	echo "Source: $(DBUS_URL)" 			>>$(DBUS_IPKG_TMP)/CONTROL/control
	...
	echo "Depends: xfree, glib2, libxml2" 	>>$(DBUS_IPKG_TMP)/CONTROL/control
