...
ifdef PTXCONF_CONSOLE-TOOLS-CONSOLECHARS_INSTALL
	...
	cp -a $(TOPDIR)/config/pdaXrom-ipaq/ipaq-sa-stuff/* $(ROOTFS_DIR)/ipkg/
...
ifndef PTXCONF_DEVFSD
	...
	cd $(TOPDIR)/bootdisk/ && md5sum initrd.jffs2 >$(TOPDIR)/bootdisk/initrd.jffs2.md5sum
	echo "pdaXrom-h3600 initrd.jffs2 initrd.jffs2.md5sum root" >$(TOPDIR)/bootdisk/reflash.ctl

#	rm -f $(TOPDIR)/bootdisk/initrd.jffs2.gz
#	gzip -9 $(TOPDIR)/bootdisk/initrd.jffs2
#	md5sum $(TOPDIR)/bootdisk/initrd.jffs2.gz >$(TOPDIR)/bootdisk/initrd.jffs2.gz.md5sum
	touch $@
