...
LIBGNOME_VERSION	= 2.10.0
LIBGNOME		= libgnome-$(LIBGNOME_VERSION)
LIBGNOME_SUFFIX		= tar.bz2
LIBGNOME_URL		= ftp://ftp.acc.umu.se/pub/GNOME/sources/libgnome/2.10/$(LIBGNOME).$(LIBGNOME_SUFFIX)
...
$(STATEDIR)/libgnome.targetinstall: $(libgnome_targetinstall_deps)
	...
	$(TOPDIR)/scripts/bin/make-locale-ipks.sh libgnome $(LIBGNOME_IPKG_TMP)
	...
	echo "Source: $(LIBGNOME_URL)"						>>$(LIBGNOME_IPKG_TMP)/CONTROL/control
